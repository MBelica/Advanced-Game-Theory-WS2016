...
\begin{definition}[Perfect Recall]
	A player has \textbf{perfect recall} if he doesn't \enquote{forget} what she once knew, including her own actions. In laymen's terms, a game in extensive form exhibits recall if all elements in an information set of player $i$ are induced by the same action of $i$ in an earlier stage of the game. 
\end{definition}
